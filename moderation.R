...
exclude_cols <- c("pulseid","los","ethnic","q1_s","q2_s","q3_s","q4_s","q5_s","q6_s","q7_s",
                  "q8_s","q9_s","q10_s","gender", "sector","female_mgr", "progress", "num_managers", "org_nor")
df <- df %>%
...
model_df <-lm(q9_s ~ group * wave* stratum + q1_s +  q2_s + q3_s + q4_s + q5_s + q6_s +
...
kable(model_tidy, digits = 3, caption = "Estimation Table for the Impact of Treatment, Time on `q9_s`: Moderation by Stratum",
...
ft <- set_caption(ft, caption = "Estimation Table for the Impact of Treatment, Time on `q9_s`: Moderation by Stratum")
...
#print(doc, target = "moderation_table.docx")
